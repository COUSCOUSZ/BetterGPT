export const messageStyles: Record<string, string> = {
    ...
    qwen:"bg-[#EDEFF5] hover:bg-[#dbdfeb] dark:bg-gray-900 text-gray-51 dark:text-[#e3e3e3]",
    // deepseek:"bg-[#dbeafe] text-[#262626] dark:bg-[#272a30] dark:hover:bg-[#1f3760]  dark:text-[#e4e4e7]"
...
export const backgroundStyles: Record<string, string> = {
    ...
    qwen:"dark:bg-gray-950 dark:text-gray-200 bg-[#F7F8FC] text-gray-900",
    // deepseek: "bg-[##f9fbff] text-[#262626] dark:bg-[#212327] dark:text-[#e4e4e7]"
};