...
const Footer = ({target,reload,isLoading}:Props) => {
    ...
    return (
        <div className={`fixed w-[20rem] bottom-0 flex gap-2 items-center border-t border-[#ffffff1a] text-[#b4b4b4] ${bgCSS}`}>
            ...
            <div className="flex items-center justify-end gap-6 p-4 w-full">
                ...
                <a href="https://github.com/cOUSCOUSZ/Bettergpt" target="_blank">
                    <svg
                        viewBox="0 0 256 250"
                        width="23"
                        height="22"
                ...
                <RotateCw className={`cursor-pointer ${isLoading && "animate-spin"}`} size={22} onClick={reload}/>
            </div>
        </div>
    )
}
